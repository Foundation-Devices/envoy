        ...
        RichText(
          ...
          text: TextSpan(
              children: unit == AmountDisplayUnit.fiat
                  ? buildFiatTextSpans(amountSats, fxRateFiat!, fakeFiat: fakeFiat, textStyle,
...
List<TextSpan> buildFiatTextSpans(
    ...
    String decimalSeparator,
    String groupSeparator,
    {required bool millionaireMode, double? fakeFiat}) {
  List<TextSpan> textSpans = [];
  ...
  if (millionaireMode) {
    ...
    // Display the original amount
    if (fakeFiat != null) {
      String formattedFakeFiat = fakeFiat.toStringAsFixed(2); // Adjust decimal places if needed
