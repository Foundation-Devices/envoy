...
class PeerToPeerCard extends ConsumerStatefulWidget {
  const PeerToPeerCard({super.key});

  @override
  ConsumerState<PeerToPeerCard> createState() => _PeerToPeerCardState();
}

class _PeerToPeerCardState extends ConsumerState<PeerToPeerCard> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    BuyOptionCard(
                      ...
                      label:
                          S().buy_bitcoin_buyOptions_peerToPeer_options_peach,
                      description: S()
