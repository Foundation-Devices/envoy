    ...
    if (context.mounted) {
      showEnvoyDialog(
        ...
        dialog: EnvoyPopUp(
          ...
          showCloseButton: true,
          content:
              "Passport Prime not connected. Please turn on your Passport Prime, ensure Bluetooth is enabled, and try again.",
...
void _showPairingProgressDialog(BuildContext context) {
  if (context.mounted) {
    showEnvoyDialog(
      context: context,
      dismissible: true,
