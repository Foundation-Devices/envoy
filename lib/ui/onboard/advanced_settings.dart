...
class _AdvancedSettingsOptionsState
    ...
    return MediaQuery.removePadding(
      ...
      child: Material(
        ...
        child: EnvoyScaffold(
          ...
          child: Stack(
            children: [
              AppBackground(showRadialGradient: true),
              Padding(
                                          ...
                                          child: EnvoyToggle(
                                            ...
                                            onChanged: (bool value) async {
                                              if (!value) {
                                                showEnvoyPopUp(
                                                  context,
                                                  S().onboarding_advancedModal_content,
                                                  S().component_back,
                                                  (context) {
                                                    Navigator.pop(context);
                                                  },
  ...
  Widget buildDivider() {
    return const Padding(
      ...
      child: Divider(height: 4, color: EnvoyColors.textInactive),
    );
  }
