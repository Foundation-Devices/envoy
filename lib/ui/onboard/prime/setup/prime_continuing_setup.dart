                        ...
                        Expanded(
                          child: Consumer(
                            builder: (context, ref, child) {
                              ...
                              final setUpMasterKey = ref.watch(
                                setUpMasterKeyProvider,
                              );
                              final backUpMasterKey = ref.watch(
                                backUpMasterKeyProvider,
                              );
                              final connectAccount = ref.watch(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: EnvoySpacing.medium1),
                                        EnvoyStepItem(step: connectAccount),
                                      ],
                                    ),
                                  ],
                                ),
