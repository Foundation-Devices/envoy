...
base class Wallet extends ffi.Struct {
...
base class Utxo extends ffi.Struct {
...
base class UtxoList extends ffi.Struct {
  @ffi.Uint32()
...
base class ServerFeatures extends ffi.Struct {
...
base class Transaction extends ffi.Struct {
  external ffi.Pointer<ffi.Char> txid;
...
base class TransactionList extends ffi.Struct {
  @ffi.Uint32()
...
base class Psbt extends ffi.Struct {
  @ffi.Uint64()
  external int sent;
...
base class RBFfeeRates extends ffi.Struct {
  @ffi.Double()
...
base class RawTransactionOutput extends ffi.Struct {
  @ffi.Uint64()
  external int amount;
...
base class RawTransactionInput extends ffi.Struct {
  @ffi.Uint32()
...
base class RawTransaction extends ffi.Struct {
  @ffi.Int32()
...
base class Seed extends ffi.Struct {
