...
import 'package:ngwallet/src/generated_bindings.dart';
...
base class NativeTransactionList extends Struct {
  @Uint32()
  external int transactionsLen;
  external Pointer<NativeTransaction> transactions;
}

base class NativeTransaction extends Struct {
