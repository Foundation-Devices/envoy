...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1535938694;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__simple__Wallet_new_impl(port, ptr, rust_vec_len, data_len),
        2 => wire__crate__api__simple__Wallet_next_address_impl(port, ptr, rust_vec_len, data_len),
