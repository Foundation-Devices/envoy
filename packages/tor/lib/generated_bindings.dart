...
late final _tor_startPtr = _lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Char> )>>('tor_start');
late final _tor_start = _tor_startPtr.asFunction<bool Function(ffi.Pointer<ffi.Char> )>();
...
late final _tor_helloPtr = _lookup<ffi.NativeFunction<ffi.Void Function()>>('tor_hello');
