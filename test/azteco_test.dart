...
void main() {
  test("Test create voucher from url", () async {
    ...
    await Tor.init();
    //await Tor().start();
    await voucher.redeem(redeemUrl);
  });

  // test("Redeem code", () {
  //   //voucher.redeem("https://azte.co/fd_despatch.php?CODE_1=8042&CODE_2=3544&CODE_3=4181&CODE_4=5682&ADDRESS=3H7g6JtnR6LATgdpuYWrRov6tyedam2L7m");
  // });
