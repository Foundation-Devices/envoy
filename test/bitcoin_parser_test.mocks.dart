...
class MockWallet extends _i1.Mock implements _i2.Wallet {
  ...
  @override
  _i4.Future<String> getAddress() => (super.noSuchMethod(
        Invocation.method(
          #getAddress,
          [],
        ),
  ...
  @override
  _i4.Future<String> getChangeAddress() => (super.noSuchMethod(
        Invocation.method(
          #getChangeAddress,
          [],
        ),
  ...
  @override
  _i4.Future<_i2.Psbt> createPsbt(
    String? sendTo,
    int? amount,
    double? feeRate, {
    List<_i2.Utxo>? mustSpendUtxos,
    List<_i2.Utxo>? dontSpendUtxos,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i4.Future<_i2.Psbt>.value(_FakePsbt_0(
          this,
          Invocation.method(
            #createPsbt,
            [
      ...
      ) as _i4.Future<_i2.Psbt>);

  @override
  _i4.Future<_i2.Psbt> decodePsbt(String? base64Psbt) => (super.noSuchMethod(
        Invocation.method(
          #decodePsbt,
          [base64Psbt],
        ),
  ...
  @override
  _i4.Future<bool> validateAddress(String? address) => (super.noSuchMethod(
        Invocation.method(
          #validateAddress,
          [address],
        ),
  ...
  @override
  _i4.Future<String> signPsbt(String? psbt) => (super.noSuchMethod(
        Invocation.method(
          #signPsbt,
          [psbt],
        ),
