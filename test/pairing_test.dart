...
void main() async {
  ...
  test('Taproot pairing test', () async {
    ...
    final account = await getPassportAccountFromJson(json);

    expect(account.name, "Primary (#0)");
    expect(account.deviceSerial, "3BAB-1BE4-5780-FC98");
    expect(account.preferredAddressType, AddressType.p2Wpkh);
  });
}
