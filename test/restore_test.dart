...
void main() {
  test('Migrate old SharedPreferences backups to sembast format', () async {
    Map<String, String> backupData = {
      "settings":
          r'{"displayUnit":"btc","selectedFiat":null,"environment":"production","selectedElectrumAddress":"ssl://mainnet.foundationdevices.com:50002","usingDefaultElectrumServer":true,"usingTor":true,"nguServerAddress":"https://ngu.foundationdevices.com","syncToCloudSetting":true,"allowScreenshotsSetting":false,"showTestnetAccountsSetting":false}',
      "accounts":
